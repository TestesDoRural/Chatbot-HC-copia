...
const MainHome: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center p-10 bg-white rounded-lg shadow-xl mt-25 ml-auto mr-auto w-2/3 mb-10 sm:mt-20 md:mt-35 lg:mt-35 xl:mt-40">
